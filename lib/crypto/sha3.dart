...
class SHA3256Digest extends BaseDigest implements Digest {
  ...
  static final FactoryConfig FACTORY_CONFIG = new DynamicFactoryConfig(
      ...
      (_, final Match match) => () {
            ...
            return new SHA3256Digest(bitLength);
          });
  ...
  void _initSponge(int rate, int capacity) {
    if ((rate + capacity) != 1600) {
      final rateWithCapacity = rate + capacity;
      throw new StateError(
          "Value of (rate + capacity) is not 1600: $rateWithCapacity");
    }
